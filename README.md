...
- By default, signatures generated by a session key cannot be verified via [ERC-1271](https://eips.ethereum.org/EIPS/eip-1271) (to avoid signature abuse such as Permit2-based transfers).
