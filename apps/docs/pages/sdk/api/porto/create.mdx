...
- [`Implementation.contract()`](#TODO): Requests & signing is handled locally directly to the delegation contract.

:::warning
Using `Implementation.contract()` comes with some caveats. Please refer to the [`Implementation.contract()`](#TODO) documentation for more information.
:::
